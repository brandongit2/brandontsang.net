					...
					<div className="relative">
						<div className="absolute inset-0">
							<Canvas
								...
								linear
								gl={(canvas) =>
									new WebGLRenderer({canvas, context: canvas.getContext(`webgl2`) ?? undefined, alpha: true})
								}
							>
								<OrthographicCamera
									makeDefault
				...
				<div className="px-6 py-12 flex flex-col gap-4 overflow-auto min-h-0">
					<p className="text-sm opacity-80">
						...
						<span className="opacity-30">
							My work lies at a unique intersection between tech and art. I have several years of professional
							experience under my belt, and have spent even longer programming as a hobby. The reason I got into
							programming was the ability to create tools with pretty much unlimited freedom; I love how technology
							enables us to create such expansive experiences for our users. It&apos;s like graphic design superpowered
							by computers!
						</span>
						{` `}
					...
					<p className="text-sm opacity-80">
						...
						{` `}
						I&apos;m perfectly happy with web development, but I would love the chance to work with 3D graphics,
						including XR and game development.{` `}
						<span className="opacity-30">
							That&apos;s my story, I guess. Also, I&apos;m currently looking for a job!
						</span>
						{` `}
