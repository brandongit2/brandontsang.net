...
export default async function SprintzeroPage() {
	...
	return (
		<div className="flex flex-col items-center gap-4">
			...
			<p className="mx-3 -mt-3 mb-4 flex max-w-xl flex-col gap-4 px-8 text-justify font-medium leading-snug text-[oklch(97.1%_0.07_110.543)] opacity-70">
			...
			<div className="mx-3 mt-8 max-w-xl pb-[50%] text-justify font-light leading-snug tracking-wide text-[oklch(97.1%_0.07_110.543)] [&_p:not(.indent-0)]:indent-4">
