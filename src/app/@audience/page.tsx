			...
			<div className="flex h-full flex-col items-start gap-4 overflow-auto p-6 text-text">
				<p>
					...
					<span className="opacity-30">
						...
						university came, I decided against studying computer science and so put programming aside for a while.
						During the pandemic, I decided to pick it back up again, and in 2021 I dropped out of university and began
						working as a software developer full-time.
					</span>
				</p>
				<p>
					<span className="opacity-30">So what am I doing now?</span>
					{` `}I&apos;ve worked in several SaaS companies building some very fulfilling products, and now I&apos;m
					...
					{` `}If you&apos;d like to reach out, I&apos;d be happy to talk more about my abilities and how they can help
					at your company.
				</p>
				<a
